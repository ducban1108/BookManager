    ...
    public void onBindViewHolder(TypeBookHolder holder, final int position) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edtID = dialog.findViewById(R.id.edtMatheloai);
//                edtID.setVisibility(View.GONE);
                edtName = dialog.findViewById(R.id.edtName);
                edtDes = dialog.findViewById(R.id.edtMota);
                edtPos = dialog.findViewById(R.id.edtVitri);
                btnAddTypeBook = dialog.findViewById(R.id.btnThemtheloai);
